...
| block_cache_num_items     | Number of block cache items for underlying store                                          |
| block_cache_num_victims   | Number of block cache victims (evicted items) for underlying store                        |
| block_cache_num_immutables| Number of block cache immutables (eligible for eviction) for underlying store             |
